...
from .types import ListOfDictsDatasetType, TransformElementType
...
class BaseMapper(Generic[D, S], metaclass=ABCMeta):
    ...
    @abstractmethod
    def map(self: "BaseMapper", dataset: D, **map_kwargs: Any) -> D:
    ...
    @abstractmethod
    def transform(self: "BaseMapper", data: S) -> S:
